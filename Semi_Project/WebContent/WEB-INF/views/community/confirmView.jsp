...
<section id="board-container">
	...
	<table id="tbl-board-view">
		...
		<tr>
			...
			<img src="<%=request.getContextPath() %>/upload/board/<%=confirm.getAttach().getRenamed_filename() %>" alt=""  style="width:200px"/>
			<% } %> <br />
			<%=confirm.getA_content() %></td>
		</tr>
		<tr>
			<th>첨부파일</th>
			<td colspan="4">
